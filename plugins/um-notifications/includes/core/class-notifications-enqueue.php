...
class Notifications_Enqueue {
	...
	function wp_enqueue_scripts() {
		...
		wp_register_script('um_notifications', um_notifications_url . 'assets/js/um-notifications' . $suffix . '.js', array( 'jquery', 'wp-util', 'um-moment', 'um-moment-timezone', 'um_scripts', 'um_functions', 'um_dropdown' ), um_notifications_version, true );
